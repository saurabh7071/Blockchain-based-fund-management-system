...
import { AuthSocialButtons } from "@/app/components/ui/auth-social-buttons"
...
export default function LoginPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-16 flex justify-center items-center min-h-[calc(100vh-64px)] relative">
            ...
            <Card
                className={`w-full max-w-md relative z-20 transition-all duration-700 ease-out ${animationComplete ? "opacity-100 scale-100 shadow-2xl" : "opacity-0 scale-90"
                    }`}
            >
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Button
                            type="submit"
                            className={`w-full bg-orange-600 hover:bg-orange-700 text-white transition-all duration-300 ${isLoading ? "opacity-80" : ""
                                }`}
                            disabled={isLoading}
                        >
