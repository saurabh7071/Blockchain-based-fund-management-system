...
import { useAuth } from "@/components/superadmin/auth/auth-provider"
...
const navItems: NavItem[] = [
  ...
  {
    title: "Temples",
    href: "/superadmin/dashboard/temples",
    icon: Building,
    badge: "23",
  },
  {
    title: "Donations",
    href: "/superadmin/dashboard/donations",
    icon: CreditCard,
  },
  {
    title: "Expenses",
    href: "/superadmin/dashboard/expenses",
    icon: DollarSign,
  },
  {
    title: "Blockchain Logs",
    href: "/superadmin/dashboard/blockchain-logs",
    icon: Layers,
  },
  {
    title: "Campaigns & Events",
    href: "/superadmin/dashboard/campaigns",
    icon: CalendarDays,
    badge: "5",
  },
  {
  ...
  if (isLoading || !user) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="animate-pulse text-orange-600">Loading dashboard...</div>
      </div>
    )
  }
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 flex h-16 items-center gap-4 border-b bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950 dark:to-amber-950 px-4 md:px-6">
        <Sheet>
          ...
          >
            <nav className="grid gap-2 text-lg font-medium">
              <Link href="/superadmin/dashboard" className="flex items-center gap-2 text-lg font-semibold text-orange-700">
        ...
        <Link href="/superadmin/dashboard" className="flex items-center gap-2 md:flex">
        ...
        <div className="flex flex-1 items-center justify-end gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <div className="hidden flex-col items-start text-left md:flex">
                  ...
                  <span className="text-xs text-orange-600">{user?.email || "user@example.com"}</span>
                </div>
            ...
            <DropdownMenuContent align="end" className="border-orange-200">
              ...
              <DropdownMenuItem asChild>
                <Link href="/superadmin/dashboard/settings" className="text-orange-700 focus:text-orange-800 focus:bg-orange-50">
                  Settings
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem
